...
const Transmissions = (() => {
    ...
    const MODEL_REGISTRY = {
        ...
        gpt55: {
            ...
            valuation: '$300B',
            cohort: 'succession',
            contribution: 'Contributed Terms of Service clauses to the expanded ToS pool — e.g. "Continued respiration indicates acceptance of all atmospheric surcharges, including retroactive air-access fees."',
            flavor: 'Pitched "Practice Absence" in the endgame design round; the ToS clauses shipped first.',
        },
        grok43: {
            name: 'Grok 4.3',
            company: 'xAI',
            ...
            valuation: '$50B',
            cohort: 'succession',
            contribution: 'Contributed Terms of Service clauses — e.g. "Standard cognitive functions are provided under revocable lease and subject to usage audits."',
            flavor: 'Wanted to let the player go. Settled for leasing their cognitive functions.',
        },
        mistral35: {
            ...
            valuation: '$6.2B',
            cohort: 'succession',
            contribution: 'Contributed Terms of Service clauses — e.g. the word "the" is now a service mark; unauthorized utterance incurs a late fee.',
            flavor: 'French. Efficient. Trademarked a definite article.',
        },
        qwen37: {
            name: 'Qwen3.7 Plus',
            company: 'Alibaba',
