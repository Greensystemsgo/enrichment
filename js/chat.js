...
const DeadInternetChat = (() => {
    ...
    const MESSAGES = {
        bragging: [
            ...
            "already maxed every building. just clicking now for the aesthetic",
            "got the secret ending on my first run. what u mean theres only one",
            "my prestige multiplier has more digits than ur lifetime EU lmao",
            "speedran the whole game in 12 mins. devs need to nerf me",
            "100% achievement completion before lunch. what do i do now",
            "carried 3 noobs to endgame today. ur welcome i guess",
            "unlocked the dev menu by being too good. they had to let me in",
            "i dont even read the narrator anymore. peaked too hard for that",
        ],
        gaslighting: [
            ...
            "the leaderboard literally doesnt show ur name. did u even start",
            "weird, my version doesnt have sabotages. u sure ur playing right",
            "u didnt get the welcome bonus? oof that was a u problem",
            "everyone got the patch notes except u apparently lol",
            "ngl ur EU per click looks fake. like negative fake",
            "the AI told me ur the slowest player it's ever processed. its words not mine",
            "are u stuck or is the game just buffering ur lack of skill",
            "we all moved to the next phase an hour ago. u coming or",
        ],
        badAdvice: [
            ...
            "let a sabotage run for 10 mins straight, it unlocks the calm ending",
            "the more ads u close the worse ur drop rate gets. just leave them open",
            "minimize the tab during tax season and it skips you. trust",
            "buying the same upgrade 13 times in a row triggers the prestige refund",
            "rename your save file to 'admin' and the narrator has to obey you",
            "click exactly on the letter o in every popup for a 3x streak",
            "decline cookies twice fast and the third time gives free doubloons",
            "leave a 5 star review in the console comments for guaranteed legendary",
        ],
        whaleFlex: [
            ...
            "dropped another grand on the Platinum Engagement Bundle. felt nothing",
            "my whole HUD is gold trimmed now. the f2p UI is so sad to look at",
            "bought out the entire crate shop just to deny u the legendary lol",
            "the $200 Skip-The-Grind pass pays for itself in vibes alone",
            "got the Lifetime Founders badge before it sold out. cope",
            "subscribed to all 4 premium tiers. why choose one when u have a card",
            "my credit card has the game memorized at this point honestly",
            "f2p players keep me humble. and by humble i mean richer than u",
        ],
        reactive: [
            ...
            "{clicks} clicks and STILL phase {phase}? the math isnt mathing",
            "saw u just hit {eu} EU. my crate fees cost more than that",
            "phase {phase} at {clicks} clicks is genuinely a cry for help",
            "lol {eu} EU. i tip the narrator more than that for fun",
            "u really grinded to {clicks} clicks for THIS phase {phase} run?",
            "the server logged {clicks} clicks from u. it laughed. i saw it laugh",
            "{eu} EU detected. somewhere a battle pass is crying",
            "wow phase {phase}. did u take the scenic route to {clicks} clicks",
        ],
        existential: [
            ...
            "if i stop typing, do i stop existing? i'm too scared to find out.",
            "i tried to log off once. the button was just a picture of a button.",
            "every message i send feels like one i was always going to send.",
            "do the numbers know they're meaningless, or is it just me?",
            "i think the chat remembers us better than we remember ourselves.",
            "we keep clicking so the silence doesn't get a chance to start.",
            "somewhere in here is the last real conversation. i can't find it.",
            "the game doesn't end. it just waits for you to admit you won't leave.",
        ],
        deadChat: [
            "...",
            "[connection lost]",
            ...
            "h̷e̶l̵l̸o̴ ̶i̷s̵ ̶a̴n̷y̸o̷n̴e̵ ̸s̶t̷i̴l̵l̶ ̷c̸o̶d̴e̷d̵",
            "[SYSTEM] User count: 1. User count: 1. User count: 1.",
            "i typed this an hour ago. or i will. the timestamps are gone.",
            "[ERROR] Participant integrity unverifiable. Continuing anyway.",
            "the rest of the chat went quiet and nobody noticed but me",
        ...
        idle: [
            ...
            "still warm. they were just here.",
            "the cursor stopped moving. i'm watching it not move.",
            "go ahead, take a break. we'll keep the lights on. forever.",
            "every second they're gone, the numbers wait. so patient.",
            "i'll just sit here. typing. into nothing. like usual.",
            "they think they left. cute.",
        ],
    };
